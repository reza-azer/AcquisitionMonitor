...
export default function App() {
  ...
  const addMemberToTeam = async (teamId: string, memberData?: { name: string; position: string; avatar_url?: string }) => {
    const data = memberData || tempMembers[teamId];
                ...
                <div className="bg-white w-full max-w-md rounded-[40px] shadow-2xl relative z-10 animate-in zoom-in-95 duration-200 border border-slate-200 my-auto">
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="flex gap-3 pt-4">
                      ...
                      <button
                        onClick={() => {
                          addMemberToTeam(showAddMemberModal.teamId, newMemberForm);
