        ...
        <>
          ...
          >
            <motion.div
              ...
              className={`${modalSizes[size]} relative mx-auto w-full rounded-xl border border-slate-200 bg-white p-4 text-slate-900 shadow-xl ring-1 ring-slate-200 sm:p-6`}
            ...
            >
              ...
              <div className="mb-4 flex items-center justify-between gap-2">
                ...
                <motion.button
                  className="ml-auto rounded-full p-1.5 text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                  onClick={onClose}
